...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 24, 2024 at 02:16 AM
...
(52, 117, 1, 'Trần Thị B', 'giaovien1@gmail.com', '0987654321');
...
(116, 'sinhvien1', '$2a$10$rEoZxOi6xamP8bP4InV68OLd5gY33c0IFs1T8dZ4ZyMMNQOQyjFIy', 'sinhvien1@gmail.com', '0123456789', 'hoạt động'),
(117, 'giaovien1', '$2a$10$sm6rj0fyd.NaB9RRvq5dZ.wYCU0inIRwRhobZBLaHWdaLN22o3ENa', 'giaovien1@gmail.com', '0987654321', 'hoạt động');
...
(112, 116, 'Nguyễn Văn A', 'CNTT1', 1, 2023);
...
(7, 'Phụ Huynh', 'Theo dõi thông tin học sinh, tham gia các sự kiện học sinh và tương tác với giáo viên.'),
(8, 'Khách Vãng Lai', 'Khách vãng lai, không có quyền truy cập vào hệ thống.');
...
--
ALTER TABLE `vaitro`
  MODIFY `id_vaitro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
